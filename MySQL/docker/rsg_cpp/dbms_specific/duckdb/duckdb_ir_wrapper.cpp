...
IRTYPE DuckDBIRWrapper::get_cur_stmt_type_from_sub_ir(IR* cur_ir)
{
    if (cur_ir == nullptr) {
        cerr << "Error: Getting nullptr from DuckDBIRWrapper::get_cur_stmt_type_from_sub_ir;\n\n\n";
        abort();
    }
...
bool DuckDBIRWrapper::is_in_subquery(IR* cur_stmt, IR* check_node, bool output_debug)
{
...
bool DuckDBIRWrapper::is_ir_statement_typed(IRTYPE ir_type)
{
