...
#ifndef MYSQL_QUERY_INSTANTIATOR_H
#define MYSQL_QUERY_INSTANTIATOR_H
...
class MySQLQueryInstantiator : public QueryInstantiator {
private:
...
public:
    ...
    MySQLQueryInstantiator() = default;
    ~MySQLQueryInstantiator() = default;
};
