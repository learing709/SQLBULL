...
static inline void* DFL_ck_alloc_nozero(u32 size)
{
    ...
    ret = static_cast<char*>(malloc(size + ALLOC_OFF_TOTAL));
...
static inline u8* DFL_ck_alloc(u32 size)
{
    ...
    return static_cast<u8*>(memset(mem, 0, size));
}
...
static inline void DFL_ck_free(void* mem)
{
    ...
    free(static_cast<char*>(mem) - ALLOC_OFF_HEAD);
}
...
static inline void* DFL_ck_realloc(char* orig, u32 size)
{
    ...
    ret = static_cast<char*>(realloc(static_cast<void*>(orig), size + ALLOC_OFF_TOTAL));
    ALLOC_CHECK_RESULT(ret, size);
...
static inline void* DFL_ck_realloc_block(void* orig, u32 size)
{
    ...
    return DFL_ck_realloc(static_cast<char*>(orig), size);
}
...
static inline u8* DFL_ck_strdup(u8* str)
{
    ...
    return static_cast<u8*>(memcpy(ret, str, size));
}
...
static inline u8* DFL_ck_memdup_str(u8* mem, u32 size)
{
    ...
    ALLOC_CHECK_SIZE(size);
    ret = static_cast<u8*>(malloc(size + ALLOC_OFF_TOTAL + 1));
    ALLOC_CHECK_RESULT(ret, size);
    ...
    u32 line)
{
    ...
    TRK[bucket] = DFL_ck_realloc_block(TRK[bucket], (TRK_cnt[bucket] + 1) * sizeof(struct TRK_obj));
