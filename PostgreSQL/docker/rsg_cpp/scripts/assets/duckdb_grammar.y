...
%type <list> macro_definition_list table_macro_list table_macro_list_internal%type <str> opt_storage_drop_specifier
%type <str> file_name
%type <str> opt_ext_version
%type <loadinstalltype> opt_force%type <node>	select_no_parens select_with_parens select_clause
...
%type <node> struct_expr list_expr map_expr
...
%type <node> where_clause 				a_expr b_expr c_expr d_expr AexprConst opt_slice_bound extended_indirection_el
				columnref columnref_opt_indirection in_expr having_clause qualify_clause func_table
%type <list>	rowsfrom_item rowsfrom_list opt_col_def_list
%type <boolean> opt_ordinality
%type <list>	func_arg_list
%type <node>	func_arg_expr
%type <node>	list_comprehension_lhs
...
%type <node> execute_param_expr%type <transactiontype> opt_transaction_type
%type <node> comment_value
%type <objtype> comment_on_type_any_name%type <ival> vacuum_option_elem
...
%type <conststr> copy_database_flag%type <list> opt_enum_val_list
...
%type <node> UpdateExtensionsStmt
...
OptSeqOptList: SeqOptList							{ $$ = $1; }
			| /*EMPTY*/								{ $$ = NIL; }
		;
#line 1 "third_party/libpg_query/grammar/statements/create_secret.y"
/*****************************************************************************
 *
 * Create a secret
 *
...
opt_storage_specifier:
        ...
        | IN_P IDENT                                { $$ = $2; }
    ;
#line 1 "third_party/libpg_query/grammar/statements/update_extensions.y"
/*****************************************************************************
 *
 *		QUERY:
...
SignedIconst: Iconst								{ $$ = $1; }
			...
			| '-' Iconst							{ $$ = - $2; }
		;
#line 1 "third_party/libpg_query/grammar/statements/drop_secret.y"
/*****************************************************************************
 *
 * Drop a secret
 *
...
opt_col_id:
	ColId 						{ $$ = $1; }
	| /* empty */ 				{ $$ = NULL; }
#line 1 "third_party/libpg_query/grammar/statements/comment_on.y"
/*****************************************************************************
 *
 * Create a Comment
 *
...
unreserved_keyword: ABORT_P | ABSOLUTE_P | ACCESS | ACTION | ADD_P | ADMIN | AFTER | AGGREGATE | ALSO | ALTER | ALWAYS | ASSERTION | ASSIGNMENT | AT | ATTACH | ATTRIBUTE | BACKWARD | BEFORE | BEGIN_P | BY | CACHE | CALL_P | CALLED | CASCADE | CASCADED | CATALOG_P | CENTURIES_P | CENTURY_P | CHAIN | CHARACTERISTICS | CHECKPOINT | CLASS | CLOSE | CLUSTER | COMMENT | COMMENTS | COMMIT | COMMITTED | COMPRESSION | CONFIGURATION | CONFLICT | CONNECTION | CONSTRAINTS | CONTENT_P | CONTINUE_P | CONVERSION_P | COPY | COST | CSV | CUBE | CURRENT_P | CURSOR | CYCLE | DATA_P | DATABASE | DAY_P | DAYS_P | DEALLOCATE | DECADE_P | DECADES_P | DECLARE | DEFAULTS | DEFERRED | DEFINER | DELETE_P | DELIMITER | DELIMITERS | DEPENDS | DETACH | DICTIONARY | DISABLE_P | DISCARD | DOCUMENT_P | DOMAIN_P | DOUBLE_P | DROP | EACH | ENABLE_P | ENCODING | ENCRYPTED | ENUM_P | ESCAPE | EVENT | EXCLUDE | EXCLUDING | EXCLUSIVE | EXECUTE | EXPLAIN | EXPORT_P | EXPORT_STATE | EXTENSION | EXTENSIONS | EXTERNAL | FAMILY | FILTER | FIRST_P | FOLLOWING | FORCE | FORWARD | FUNCTION | FUNCTIONS | GLOBAL | GRANTED | GROUPS | HANDLER | HEADER_P | HOLD | HOUR_P | HOURS_P | IDENTITY_P | IF_P | IGNORE_P | IMMEDIATE | IMMUTABLE | IMPLICIT_P | IMPORT_P | INCLUDE_P | INCLUDING | INCREMENT | INDEX | INDEXES | INHERIT | INHERITS | INLINE_P | INPUT_P | INSENSITIVE | INSERT | INSTALL | INSTEAD | INVOKER | ISOLATION | JSON | KEY | LABEL | LANGUAGE | LARGE_P | LAST_P | LEAKPROOF | LEVEL | LISTEN | LOAD | LOCAL | LOCATION | LOCK_P | LOCKED | LOGGED | MACRO | MAPPING | MATCH | MATERIALIZED | MAXVALUE | METHOD | MICROSECOND_P | MICROSECONDS_P | MILLENNIA_P | MILLENNIUM_P | MILLISECOND_P | MILLISECONDS_P | MINUTE_P | MINUTES_P | MINVALUE | MODE | MONTH_P | MONTHS_P | MOVE | NAME_P | NAMES | NEW | NEXT | NO | NOTHING | NOTIFY | NOWAIT | NULLS_P | OBJECT_P | OF | OFF | OIDS | OLD | OPERATOR | OPTION | OPTIONS | ORDINALITY | OTHERS | OVER | OVERRIDING | OWNED | OWNER | PARALLEL | PARSER | PARTIAL | PARTITION | PASSING | PASSWORD | PERCENT | PERSISTENT | PLANS | POLICY | PRAGMA_P | PRECEDING | PREPARE | PREPARED | PRESERVE | PRIOR | PRIVILEGES | PROCEDURAL | PROCEDURE | PROGRAM | PUBLICATION | QUARTER_P | QUARTERS_P | QUOTE | RANGE | READ_P | REASSIGN | RECHECK | RECURSIVE | REF | REFERENCING | REFRESH | REINDEX | RELATIVE_P | RELEASE | RENAME | REPEATABLE | REPLACE | REPLICA | RESET | RESPECT_P | RESTART | RESTRICT | RETURNS | REVOKE | ROLE | ROLLBACK | ROLLUP | ROWS | RULE | SAMPLE | SAVEPOINT | SCHEMA | SCHEMAS | SCOPE | SCROLL | SEARCH | SECOND_P | SECONDS_P | SECRET | SECURITY | SEQUENCE | SEQUENCES | SERIALIZABLE | SERVER | SESSION | SET | SETS | SHARE | SIMPLE | SKIP | SNAPSHOT | SQL_P | STABLE | STANDALONE_P | START | STATEMENT | STATISTICS | STDIN | STDOUT | STORAGE | STORED | STRICT_P | STRIP_P | SUBSCRIPTION | SYSID | SYSTEM_P | TABLES | TABLESPACE | TEMP | TEMPLATE | TEMPORARY | TEXT_P | TIES | TRANSACTION | TRANSFORM | TRIGGER | TRUNCATE | TRUSTED | TYPE_P | TYPES_P | UNBOUNDED | UNCOMMITTED | UNENCRYPTED | UNKNOWN | UNLISTEN | UNLOGGED | UNTIL | UPDATE | USE_P | USER | VACUUM | VALID | VALIDATE | VALIDATOR | VALUE_P | VARIABLE_P | VARYING | VERSION_P | VIEW | VIEWS | VIRTUAL | VOLATILE | WEEK_P | WEEKS_P | WHITESPACE_P | WITHIN | WITHOUT | WORK | WRAPPER | WRITE_P | XML_P | YEAR_P | YEARS_P | YES_P | ZONE
...
reserved_keyword: ALL | ANALYSE | ANALYZE | AND | ANY | ARRAY | AS | ASC_P | ASYMMETRIC | BOTH | CASE | CAST | CHECK_P | COLLATE | COLUMN | CONSTRAINT | CREATE_P | DEFAULT | DEFERRABLE | DESC_P | DESCRIBE | DISTINCT | DO | ELSE | END_P | EXCEPT | FALSE_P | FETCH | FOR | FOREIGN | FROM | GRANT | GROUP_P | HAVING | IN_P | INITIALLY | INTERSECT | INTO | LATERAL_P | LEADING | LIMIT | NOT | NULL_P | OFFSET | ON | ONLY | OR | ORDER | PIVOT | PIVOT_LONGER | PIVOT_WIDER | PLACING | PRIMARY | QUALIFY | REFERENCES | RETURNING | SELECT | SHOW | SOME | SUMMARIZE | SYMMETRIC | TABLE | THEN | TO | TRAILING | TRUE_P | UNION | UNIQUE | UNPIVOT | USING | VARIADIC | WHEN | WHERE | WINDOW | WITH
