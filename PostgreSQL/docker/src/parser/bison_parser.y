...
AlterOptRoleElem:
    ...
    | UNENCRYPTED PASSWORD Sconst {
        /* XX: Force change it to ENCRYPTED PASSWORD. UNENCRYPTED PASSWORD is not supported anymore. */
        auto tmp1 = new IR(kIdentifier, string($3), kDataFixLater, kFlagUnknown);
        all_gen_ir.push_back( tmp1 );
        free($3);
        res = new IR(kAlterOptRoleElem, OP3("ENCRYPTED PASSWORD", "", ""), tmp1);
    ...
    | IDENT {
        /* XX: Restricted the possible option for ALTER role option list. If unreconized, change it to superuser. */
...
CreateSchemaStmt:
    ...
    | CREATE SCHEMA IF_P NOT EXISTS OptSchemaName AUTHORIZATION RoleSpec OptSchemaEltList {
        /* XX: Ignore optSchemaEltList. It is not supported here. */
        if ($9) {
            /* $9 -> deep_drop(); */
            rov_ir.push_back($9);
        }
...
set_rest_more:
    ...
    | ROLE NonReservedWord_or_Sconst {
        /* XX: Cannot find exact example shown on the documentation. Use it as kUse of Role. */
    ...
    | SESSION AUTHORIZATION NonReservedWord_or_Sconst {
        /* XX: This is username. This is just the wrapper for Role. */
...
zone_value:
    ...
    | IDENT {
        /* XX: Change it to a fixed location. Do not accept in random string.  */
        free($1);
...
alter_identity_column_option:
    ...
    | SET SeqOptElem {
        /* XX: Avoid using seqoptelem that is not supported.  */
        auto tmp1 = $2;
        if (tmp1) {
            /* tmp1 -> deep_drop(); */
...
hash_partbound_elem:
    ...
    NonReservedWord Iconst {
        /* XX: From the documentation, I can only see "modulus" and "remainder" available for NonReserveredWord. */
        IR* tmp1 = $2;
...
CopyStmt:
    ...
    COPY opt_binary qualified_name opt_column_list copy_from opt_program copy_file_name copy_delimiter opt_with copy_options where_clause {
        /* XX: Do not allow opt_program and copy_file_name at the same time.  */
        /* XX: Do not allow copy_from and where_clause at the same time.  */
        auto tmp1 = $2;
        auto tmp2 = $3;
...
ColConstraintElem:
    ...
    | GENERATED generated_when AS '(' a_expr ')' STORED {
        /* XX: Enforced ALWAYS in the generated_when. */
        auto tmp1 = $2;
...
key_match:
    ...
    | MATCH PARTIAL {
        /* XX: MATCH PARTIAL is not yet implemented. */
        res = new IR(kKeyMatch, OP3("MATCH FULL", "", ""));
        all_gen_ir.push_back(res);
        $$ = res;
    }
...
create_extension_opt_item:
    ...
    | VERSION_P NonReservedWord_or_Sconst {
        /* XX: The version string of the extension. No need to mutate I guess. */
    ...
    | FROM NonReservedWord_or_Sconst {
        /* XX: This symtax no longer supported. Change it to CASCADE. */
        free($2);
...
alter_extension_opt_item:
    ...
    TO NonReservedWord_or_Sconst {
        /* XX: This is again, just the verion name for the extension. No need to mutate.  */
...
CreateTrigStmt:
    ...
    | CREATE opt_or_replace CONSTRAINT TRIGGER name AFTER TriggerEvents ON qualified_name OptConstrFromTable ConstraintAttributeSpec FOR EACH ROW TriggerWhen EXECUTE FUNCTION_or_PROCEDURE func_name '(' TriggerFuncArgs ')' {
        /* XX: Do not allow "OR REPLACE" in this sentence. */
        auto tmp1 = $2;
        if (!tmp1->is_empty()){
            /* tmp1 ->deep_drop(); */
            rov_ir.push_back(tmp1);
...
def_elem:
    ...
    ColLabel '=' def_arg {
        /* XX: Treat this as reloption type. Will fix later in the validate functions */
        auto tmp1 = new IR(kIdentifier, string($1), kDataFixLater, kFlagUnknown);
        all_gen_ir.push_back( tmp1 );
        free($1);
        auto tmp2 = $3;
...
old_aggr_elem:
    ...
    IDENT '=' def_arg {
        /* XX: Fixing it as an identifier = config. We might need to fix them later in the validate function */
        IR* tmp1;
...
opt_recheck:
    ...
    RECHECK {
        /* XX: RECHECK no longer needed. Remove it. */
...
opt_provider:
    ...
    FOR NonReservedWord_or_Sconst {
        /* XX: This is for the security label string. I do not understand its context and usage.
...
index_elem:
    ...
    ColId index_elem_options {
        ...
        /* XX: This index_elem is actually pointing to table columns. */
        tmp1->set_iden_type(kDataColumnName, kUse);
    }
...
createfunc_opt_item:
    ...
    | LANGUAGE NonReservedWord_or_Sconst {
        /* XX: Assigning program language for the function. It can be c, sql, internal and other user defined language.
...
oper_argtypes:
    ...
    '(' Typename ')' {
        /* XX: This syntax is not permitted. (Weird). Change it to the third form. */
        auto tmp1 = $2;
...
dostmt_opt_item:
    ...
    | LANGUAGE NonReservedWord_or_Sconst {
        /* XX: Programming language used for the DO stmt. Do not mutate.  */
        /* FixLater: $2 into OP3 */
        if ($2 && strcmp($2, "c") == 0 || strcmp($2, "sql") == 0 || strcmp($2, "internal") == 0 || strcmp($2, "plpgsql") == 0) {
            auto tmp1 = new IR(kIdentifier, string($2), kDataFixLater, kFlagUnknown);
        all_gen_ir.push_back( tmp1 );
...
ViewStmt:
    ...
    | CREATE OptTemp RECURSIVE VIEW qualified_name '(' columnList ')' opt_reloptions AS SelectStmt opt_check_option {
        /* XX: Do not allow for opt_check_option */
        auto tmp1 = $2;
        auto tmp2 = $5;
...
createdb_opt_name:
    ...
    IDENT {
        /* XX: Weird. I don't see any documents mentioned we can define anything here.  */
        free($1);
...
utility_option_elem:
    ...
    utility_option_name utility_option_arg {
        /* XX: We do not know what is the possible values or types for this utility_option_name.
...
common_table_expr:
    ...
    name opt_name_list AS opt_materialized '(' PreparableStmt ')' opt_search_clause opt_cycle_clause {
        ...
        /* XX: This seems to only be used in the WITH Clause.
...
OptTempTableName:
    ...
    | GLOBAL TEMPORARY opt_table qualified_name {
        /* XX: GLOBAL TEMPORARY is not supported. */
        auto tmp1 = $3;
        auto tmp2 = $4;
        res = new IR(kOptTempTableName, OP3("LOCAL TEMPORARY", "", ""), tmp1, tmp2);
        all_gen_ir.push_back(res);
    ...
    | GLOBAL TEMP opt_table qualified_name {
        /* XX: GLOBAL TEMP is not supported. */
        auto tmp1 = $3;
        auto tmp2 = $4;
        res = new IR(kOptTempTableName, OP3("LOCAL TEMP", "", ""), tmp1, tmp2);
        all_gen_ir.push_back(res);
...
limit_clause:
    ...
    | LIMIT select_limit_value ',' select_offset_value {
        /* XX: Remove select_offset_value. It is not supported by Postgres.   */
        auto tmp1 = $2;
        auto tmp2 = $4;
        /* tmp2->deep_drop(); */
...
a_expr:
    ...
    | UNIQUE select_with_parens {
        /* XX: UNIQUE is not yet implemented. Removed it.  */
        auto tmp1 = $2;
        res = new IR(kAExpr, OP3("", "", ""), tmp1);
        all_gen_ir.push_back(res);
        $$ = res;
...
frame_extent:
    ...
    frame_bound {
        /* XX: Avoid unsupported bound options.  */
        auto tmp1 = $1;
...
extract_arg:
    ...
    IDENT {
        /* XX: The IDENT is used for extensions.
...
AexprConst:
    ...
    | XCONST {
        /* XX: This is actually deximal numberical string. */
    ...
    | func_name '(' func_arg_list opt_sort_clause ')' Sconst {
        /* XX: Do not allow opt_sort_clause here. Not supported by Postgres. */
        auto tmp1 = $1;
        auto tmp2 = $3;
