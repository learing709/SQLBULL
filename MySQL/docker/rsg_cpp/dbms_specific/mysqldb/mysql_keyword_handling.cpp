...
#include "mysql_keyword_handling.h"
#include "../../headers/ir_types_common.h"
#include "../../headers/node.h"
#include "../../headers/utils.h"

void mysql_keyword_handl(TokenNode*& cur_token)
{
    ...
    if (cur_str == "GRAMMAR_SELECTOR_EXPR") {
        cur_str = "";
        cur_ir->set_symbol_type(SymbolTerm);
        cur_ir->set_ir_type(IRTypeGRAMMARSELECTOREXPR);
        cur_token->set_mapped_children_prods({});
        cur_token->set_type(TypTermKeyword);
    } else if (cur_str == "LT") {
        cur_str = "<";
        cur_ir->set_symbol_type(SymbolTerm);
        cur_ir->set_ir_type(IRTypeLT);
        cur_token->set_mapped_children_prods({});
        cur_token->set_type(TypTermKeyword);
    } else if (cur_str == "LE") {
        cur_str = "<=";
        ...
        cur_str = "=";
        cur_ir->set_symbol_type(SymbolTerm);
        cur_ir->set_ir_type(IRTypeEQ);
        cur_token->set_mapped_children_prods({});
        cur_token->set_type(TypTermKeyword);
    } else if (cur_str == "GT_SYM") {
        cur_str = ">";
        cur_ir->set_symbol_type(SymbolTerm);
        cur_ir->set_ir_type(IRTypeGTSYM);
        cur_token->set_mapped_children_prods({});
        cur_token->set_type(TypTermKeyword);
    } else if (cur_str == "GE") {
        cur_str = ">=";
        ...
        cur_token->set_mapped_children_prods({});
        cur_token->set_type(TypTermKeyword);
    } else if (cur_str == "OR_OR_SYM") {
        cur_str = "||";
        cur_ir->set_symbol_type(SymbolTerm);
        cur_ir->set_ir_type(IRTypeORORSYM);
        cur_token->set_mapped_children_prods({});
        cur_token->set_type(TypTermKeyword);
    ...
    /* Not necessary. Won't use. And very slow. */
    // else if (findStringIn(cur_str, "OBSOLETE_TOKEN")) {
    //     cur_str = "";
    //     cur_ir->set_symbol_type(SymbolTerm);
