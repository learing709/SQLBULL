...
#ifndef POSTGRESQL_RESULTS_HANDLER_H
#define POSTGRESQL_RESULTS_HANDLER_H

#include "../../headers/results_handler.h"

class PostgreSQLResultHandler : public ResultHandler {
...
#endif // POSTGRESQL_RESULTS_HANDLER_H
