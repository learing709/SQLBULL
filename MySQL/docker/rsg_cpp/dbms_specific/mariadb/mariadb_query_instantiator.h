...
#ifndef MARIADB_QUERY_INSTANTIATOR_H
#define MARIADB_QUERY_INSTANTIATOR_H
...
class MariaDBQueryInstantiator : public QueryInstantiator {
private:
    ...
    MariaDBIRWrapper ir_wrapper;

    /* shared data for MariaDB specifically */
...
public:
    ...
    MariaDBQueryInstantiator() = default;
    ~MariaDBQueryInstantiator() = default;
};

#endif // MARIADB_QUERY_INSTANTIATOR_H
