...
#ifndef RSG_CPP_COCKROACHDB_QUERY_INSTANTIATOR_H
#define RSG_CPP_COCKROACHDB_QUERY_INSTANTIATOR_H
...
class CockroachDBQueryInstantiator : public QueryInstantiator {
private:
    ...
    CockroachDBIRWrapper ir_wrapper;
...
public:
    ...
    CockroachDBQueryInstantiator() = default;
    ~CockroachDBQueryInstantiator() = default;
};

#endif // RSG_CPP_COCKROACHDB_QUERY_INSTANTIATOR_H
