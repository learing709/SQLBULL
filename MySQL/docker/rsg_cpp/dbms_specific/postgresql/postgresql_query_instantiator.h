...
#ifndef POSTGRESQL_QUERY_INSTANTIATOR_H
#define POSTGRESQL_QUERY_INSTANTIATOR_H
...
class PostgreSQLQueryInstantiator : public QueryInstantiator {
private:
    ...
    PostgreSQLIRWrapper ir_wrapper;

    /* shared data for PostgreSQL specifically */
...
public:
    ...
    PostgreSQLQueryInstantiator() = default;
    ~PostgreSQLQueryInstantiator() = default;
};

#endif // MYSQL_QUERY_INSTANTIATOR_H
