...
pane.send_keys("AFL_IGNORE_PROBLEMS=1 ./bin/mysqld --basedir=./ --datadir=./data_all/ori_data --log-error=./err.err --pid-file=./pid.pid &")
time.sleep(10)
...
pane_client.send_keys("./bin/mysql -u root -e \"create database if not exists test123; create database if not exists test_init;\"")
time.sleep(5)
