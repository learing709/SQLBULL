...
#ifndef SQLITE_QUERY_INSTANTIATOR_H
#define SQLITE_QUERY_INSTANTIATOR_H
...
class SQLiteQueryInstantiator : public QueryInstantiator {
private:
    ...
    vector<string> v_all_trigger_name;
...
public:
    ...
    virtual void custom_setup_init_query_instan_data() override; // for each DBMS's fuzzer to init their own custom data.

    virtual vector<QueryStmt*> construct_custom_pre_insert_stmt() override;

    // Constructor and Destructor
    SQLiteQueryInstantiator() = default;
    ~SQLiteQueryInstantiator() = default;
};

#endif // SQLITE_QUERY_INSTANTIATOR_H
