...
#include "mysql_query_instantiator.h"
...
void MySQLQueryInstantiator::init_data_library()
{
...
void MySQLQueryInstantiator::constr_sql_func_lib_helper(json& json_obj, vector<string>& v_all_func_str,
...
void MySQLQueryInstantiator::constr_sql_func_lib(string func_types_str, vector<string>& v_all_func_str,
    map<DATAAFFINITYTYPE, vector<string>>& func_type_lib,
    map<string, vector<FunctionSignature>>& func_str_to_type_map)
{
...
void MySQLQueryInstantiator::constr_key_pair_datatype_lib_helper(json& key_pair_json, vector<string>& v_all_key_str, map<string, DataAffinity>& mapped_key_pair)
{
...
void MySQLQueryInstantiator::constr_key_pair_datatype_lib(string key_pair_str, vector<string>& v_all_key_str, map<string, DataAffinity>& mapped_key_pair)
{
...
bool MySQLQueryInstantiator::fill_one_stmt_helper(IR* cur_stmt)
{
...
*/
vector<IR*> MySQLQueryInstantiator::split_to_substmt(IR* cur_stmt,
...
bool MySQLQueryInstantiator::connect_back(map<IR*, pair<int, IR*>>& m_save)
{
...
bool MySQLQueryInstantiator::instan_preprocessing(IR* stmt_root,
...
bool MySQLQueryInstantiator::remove_type_annotation(IR* cur_stmt_root,
...
void MySQLQueryInstantiator::instan_database_schema_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_window_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_table_name(IR* ir_to_fix, bool& is_replace_table)
{
...
void MySQLQueryInstantiator::instan_table_alias_name(IR* ir_to_fix, IR* cur_stmt_root,
...
void MySQLQueryInstantiator::instan_view_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_partition_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_index_name(IR* ir_to_fix, vector<IR*>& ir_to_drop)
{
...
DATAAFFINITYTYPE MySQLQueryInstantiator::get_nearby_data_affinity(IR* ir_to_fix)
{
...
string MySQLQueryInstantiator::find_cloest_table_name(IR* ir_to_fix)
{
    string closest_table_name = "";
...
void MySQLQueryInstantiator::instan_literal(IR* ir_to_fix, IR* cur_stmt_root,
    vector<IR*>& ir_to_deep_drop)
{
...
void MySQLQueryInstantiator::instan_column_name(IR* ir_to_fix, IR*& cur_stmt_root, bool& is_replace_column, vector<IR*>& ir_to_drop)
{
...
void MySQLQueryInstantiator::instan_column_alias_name(IR* ir_to_fix, IR* cur_stmt_root,
    vector<IR*>& ir_to_deep_drop)
{
...
void MySQLQueryInstantiator::instan_sql_type_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_statistic_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_sequence_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_constraint_name(IR* ir_to_fix)
{
...
void MySQLQueryInstantiator::instan_family_name(IR* ir_to_fix)
{
...
IR* MySQLQueryInstantiator::constr_rand_func_with_affinity(DATAAFFINITYTYPE in_affi)
{
...
void MySQLQueryInstantiator::instan_func_application(IR* ir_to_fix, IR* cur_stmt_root_ir, vector<IR*>& ir_to_deep_drop,
...
void MySQLQueryInstantiator::map_create_view(IR* ir_to_fix, IR* cur_stmt_root,
    const vector<vector<IR*>> all_substmt_ir_of_interest)
{
    ...
    if (this->ir_wrapper.is_ir_in(cur_stmt_root, IRTypeViewTail)) {
...
void MySQLQueryInstantiator::map_create_view_column(IR* ir_to_fix,
    vector<IR*>& ir_to_deep_drop)
{

    IR* type_name_list = this->ir_wrapper.get_ancestor_node_matching_type(ir_to_fix, IRTypeOptDerivedColumnList);
...
void MySQLQueryInstantiator::instan_storage_param(IR* ir_to_fix, vector<IR*>& ir_to_deep_drop)
{
...
void MySQLQueryInstantiator::instan_trigger_name(IR* ir_to_fix, vector<IR*>& ir_to_deep_drop)
{
...
bool MySQLQueryInstantiator::instan_dependency(IR* cur_stmt_root,
    const vector<vector<IR*>> all_substmt_ir_of_interest)
{
...
void MySQLQueryInstantiator::custom_setup_init_query_instan_data()
{
}
