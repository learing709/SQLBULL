...
#include "duckdb_query_plan_handl.h"
#include "../../headers/utils.h"
#include <regex>

vector<string> DuckDBQueryPlanHandl::retrieve_query_plan(const string& query_in, const string& res_in)
{
 ...
 * */
vector<string> DuckDBQueryPlanHandl::retrieve_query_plan_opt(const string in)
{
    vector<string> res_out;
    // TODO:: FIXME:: Main logic here.
    return res_out;
