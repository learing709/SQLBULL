...
grammar_fd = open("assets/mysql_grammar.y", "r")

grammar_str = grammar_fd.read()
grammar_str = grammar_str.replace("a_expr']'", "a_expr ']'")
grammar_str = grammar_str.replace("query_expression_with_opt_locking_clauses')'", "query_expression_with_opt_locking_clauses ')'")
tmp_res_str = ""
