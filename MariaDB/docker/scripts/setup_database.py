...
pane.send_keys("cd /home/mariadb/mariadb-server/bld")
...
pane_client.send_keys("cd /home/mariadb/mariadb-server/bld")
pane_client.send_keys("./bin/mariadb -u mariadb -e \"create database if not exists test123; create database if not exists test_init;\"")
time.sleep(5)
