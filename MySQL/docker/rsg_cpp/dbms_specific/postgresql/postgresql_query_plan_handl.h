...
#ifndef POSTGRESQL_QUERY_PLAN_HANDL_H
#define POSTGRESQL_QUERY_PLAN_HANDL_H

#include "../../headers/query_plan_handl.h"

class PostgreSQLQueryPlanHandl : public QueryPlanHandler {
private:
...
#endif // POSTGRESQL_QUERY_PLAN_HANDL_H
