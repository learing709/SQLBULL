...
#include "mariadb_results_handler.h"
#include "../../headers/utils.h"

bool MariaDBResultHandler::is_res_error(const string& in_ret)
{
...
bool MariaDBResultHandler::is_dbms_internal_error(const string& in_ret)
{
    if (ff("got signal") || ff("crashed")
     || ff("Lost connection")
    ) {
        return true;
    } else {
